exports.encodeOrder = function (message) {
  var bb = popByteBuffer();
  _encodeOrder(message, bb);
  return toUint8Array(bb);
}

function _encodeOrder(message, bb) {
  ...
  if ($destination !== undefined) {
    writeVarint32(bb, 42);
    writeString(bb, $destination);
  }
};

exports.decodeOrder = function (binary) {
  return _decodeOrder(wrapByteBuffer(binary));
}

function _decodeOrder(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string destination = 5;
      case 5: {
        message.destination = readString(bb, readVarint32(bb));
        break;
      }
...
exports.encodeCombinedShipment = function (message) {
  var bb = popByteBuffer();
  _encodeCombinedShipment(message, bb);
  return toUint8Array(bb);
}

function _encodeCombinedShipment(message, bb) {
  // optional string id = 1;
  var $id = message.id;
  if ($id !== undefined) {
    writeVarint32(bb, 10);
  ...
  var array$orderList = message.orderList;
  if (array$orderList !== undefined) {
    for (var i = 0; i < array$orderList.length; i++) {
      var value = array$orderList[i];
      writeVarint32(bb, 26);
...
exports.decodeCombinedShipment = function (binary) {
  return _decodeCombinedShipment(wrapByteBuffer(binary));
}

function _decodeCombinedShipment(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 3: {
        ...
        var values = message.orderList || (message.orderList = []);
